...
export const PROD = 'grab-n-go-233117';

/** The url for the Google Cloud Endpoints API for your application. */
export const WEB_CLIENT_IDS: EnvironmentsVariable = {
  prod: `433779064134-rkergc61n20433ev2hmcsk90g1vv7pdt.apps.googleusercontent.com`,
  qa: `{QA_WEB_ID}`,
  dev: `{DEV_WEB_ID}`,
};
...
export const CHROME_PUBLIC_KEYS: EnvironmentsVariable = {
  prod: '433779064134-nevq3pllf31g43nvcft3mp3ob40dlr5e.apps.googleusercontent.com',
  qa: '{QA_CHROME_KEY}',
  dev: '{DEV_CHROME_KEY}',
};
...
export const IT_CONTACT_WEBSITE = 'optionsareus.com.com';
/** Email of IT; Placed on Manage/troubleshoot page. */
export const IT_CONTACT_EMAIL = 'support@optionsareus.com';
