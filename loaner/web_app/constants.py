...
ON_PROD = ON_GAE and ('grab-n-go-233117' in APPLICATION_ID)
...
ADMIN_EMAIL = 'rbrown@optionsareus.com'

# The email address application emails will come from.
SEND_EMAIL_AS = 'no-reply@optionsareus.com'
...
SUPERADMINS_GROUP = 'technical-admins@optionsareus.com'
